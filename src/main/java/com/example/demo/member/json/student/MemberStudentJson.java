...
public class MemberStudentJson {
	String memberUuid;
	...
	String memberProgramUid;
	String memberProgramName;
	String degreeLevelUid;
	String degreeLevelName;
	String sId;
	
	public static MemberStudentJson packMemberStudentJson(MemberFaculty memberFaculty) {
		MemberStudentJson memberJson = new MemberStudentJson();
		memberJson.setSId(memberFaculty.getStudentId());
		...
		memberJson.setMemberProgramUid(memberFaculty.getProgram().getProgramUuid());
		memberJson.setMemberProgramName(memberFaculty.getProgram().getProgramNameEn());
		memberJson.setDegreeLevelUid(memberFaculty.getProgram().getDegreeLevel().getDegreeLevelUuid());
		memberJson.setDegreeLevelName(memberFaculty.getProgram().getDegreeLevel().getName());
		return memberJson;
	}
}
