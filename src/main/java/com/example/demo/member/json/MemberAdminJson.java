...
public class MemberAdminJson {
	...
	public static MemberAdminJson packMemberAdminJson(Member member) {
		MemberAdminJson memberJson = new MemberAdminJson();
		...
		memberJson.setMemberBirthday(member.getMemberBirthday().plusYears(543));
		memberJson.setMemberAge(Period.between(member.getMemberBirthday().plusYears(543), LocalDate.now()).getYears());
...
//	public static List<MemberJson> packMemberJson(List<Member> members){
//		List<MemberJson> memberJsons = new ArrayList<>();
//		for(Member member : members) {
//			memberJsons.add(packMemberJson(member));
//		}
//		return memberJsons;
//	}
}