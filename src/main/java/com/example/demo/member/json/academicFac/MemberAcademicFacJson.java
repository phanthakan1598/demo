...
public class MemberAcademicFacJson {
	String memberUuid;
	...
	public static MemberAcademicFacJson packMemberAcademicFacJson(MemberFaculty memberFaculty) {
		MemberAcademicFacJson memberJson = new MemberAcademicFacJson();
