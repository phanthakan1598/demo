...
public class MemberAcademicGeJson {
	String memberUuid;
	...
	public static MemberAcademicGeJson packMemberAcademicGeJson(Member member) {
		MemberAcademicGeJson memberJson = new MemberAcademicGeJson();
